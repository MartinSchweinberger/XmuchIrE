...
```{r}
hits <- c(599, 5525, 5530,5816, 11582, 13200, 17046, 20991, 21795, 30236, 34972, 35020, 35120, 35308, 
          37854, 39600, 40453, 40876, 41221, 41370, 46497, 46498, 47517, 51719, 52752, 53110, 57010, 
          60037, 70653, 70684, 70843, 71039, 87422, 89308, 89535)
kwics <- clean_kwic3 %>%
